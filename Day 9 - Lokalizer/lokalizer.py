    ...
    def create_structure(
        ...
        if structure.type_ == StructureTypes.ROOT:
            ...
            for directory in structure.structure:
                ...
                create_files(os.path.join(directory, filename) for filename in filenames)
...
def prepare_files(filenames, ext) -> list[str]:
...
def create_files(filenames):
    for filename in filenames:
        create_empty_file(os.path.join(cwd, filename))
